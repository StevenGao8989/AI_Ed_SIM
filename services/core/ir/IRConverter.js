...
const PhysicsIR_1 = require("./PhysicsIR");
const AtomicModules_1 = require("../ai_parsing/AtomicModules");
class IRConverter {
    constructor() {
        this.VERSION = '1.0.0';
        ...
        this.atomicModuleLibrary = new AtomicModules_1.AtomicModuleLibrary();
    }
    /**
     * 生成缓存键
     */
